namespace NServiceBus
{
    ...
    public static partial class FunctionsHostBuilderExtensions
    {
        ...
        public static IHostBuilder UseNServiceBus(
            ...
            Action<RabbitMQTriggeredEndpointConfiguration> configurationFactory = null)
        {
        ...
        public static IHostBuilder UseNServiceBus(
            this IHostBuilder hostBuilder,
            Action<IConfiguration, RabbitMQTriggeredEndpointConfiguration> configurationFactory)
        {
            var callingAssembly = Assembly.GetCallingAssembly();
        ...
        static void RegisterEndpointFactory(
            ...
            Action<IConfiguration, RabbitMQTriggeredEndpointConfiguration> configurationCustomization,
            string connectionString = default)
        {
...
- Add a configuration or environment variable with the key ENDPOINT_NAME");
                ...
                var functionEndpointConfiguration = new RabbitMQTriggeredEndpointConfiguration(endpointName, configuration, connectionString);
