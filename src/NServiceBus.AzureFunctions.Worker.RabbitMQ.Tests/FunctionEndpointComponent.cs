namespace ServiceBus.Tests
{
    ...
    abstract class FunctionEndpointComponent : IComponentBehavior
    {
        ...
        public Action<RabbitMQTriggeredEndpointConfiguration> CustomizeConfiguration { private get; set; } = _ => { };
        ...
        class FunctionRunner : ComponentRunner
        {
            public FunctionRunner(
                ...
                Action<RabbitMQTriggeredEndpointConfiguration> configurationCustomization,
            ...
            {
                var functionEndpointConfiguration = new RabbitMQTriggeredEndpointConfiguration(Name, null, default);
            ...
            readonly Action<RabbitMQTriggeredEndpointConfiguration> configurationCustomization;
